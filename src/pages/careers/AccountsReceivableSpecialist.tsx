...
const AccountsReceivableSpecialist = () => {
  ...
  const whatYoullDo = t("careers.jobPages.roles.arSpecialist.whatYoullDo", {
    returnObjects: true,
  }) as string[];

  const whatWeLookFor = t("careers.jobPages.roles.arSpecialist.whatWeLookFor", {
    returnObjects: true,
  }) as string[];
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <header>
                <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-4">
                  {t("careers.positions.arSpecialist.title")}
                </h1>
                <div className="flex flex-wrap items-center gap-4 text-muted-foreground">
                  <span className="flex items-center gap-2">
                    <MapPin className="w-4 h-4" />
                    {t("careers.positions.arSpecialist.location")}
                  </span>
                  <span className="flex items-center gap-2">
                    <Briefcase className="w-4 h-4" />
                    {t("careers.jobPages.department.operations")}
                  </span>
                  <span className="px-3 py-1 bg-muted rounded-full text-sm">
                    {t("careers.positions.arSpecialist.type")}
                  </span>
                </div>
              </header>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {t("careers.jobPages.roles.arSpecialist.about")}
                </p>
              </section>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32 p-6 bg-card border border-border rounded-xl">
                ...
                <JobApplicationForm jobTitle={t("careers.positions.arSpecialist.title")} />
              </div>
            </div>
          </div>
        </div>
