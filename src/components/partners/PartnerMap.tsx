      ...
      <div className="container-wide">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">
            {t('partners.map.title')}
          </h2>
          <p className="text-muted-foreground text-lg">
            {t('partners.map.subtitle')}
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-6">
          <svg viewBox="0 0 900 470" className="w-full h-auto" style={{ pointerEvents: "none" }}>
            <defs>
              <radialGradient id="atlantic-glow" cx="50%" cy="50%" r="50%">
            ...
            <ellipse cx="340" cy="220" rx="120" ry="100" fill="url(#atlantic-glow)" opacity={getAtlanticOpacity()} />
            {[{ cx: 155, cy: 215, delay: "0s" }, { cx: 440, cy: 158, delay: "0.75s" }].map((dot, i) => (
              <g key={i}>
                <circle cx={dot.cx} cy={dot.cy} r="12" fill="#1a8a9a" opacity="0.15" filter="url(#dot-glow)">
