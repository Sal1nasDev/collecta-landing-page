        ...
        <div className="grid md:grid-cols-3 gap-8">
          {valueKeys.map((key, i) => {
            ...
            return (
              <div
                key={key}
                className={`bg-white border border-[#e2e8f0] rounded-2xl p-8 md:p-10 h-full transition-all duration-600 hover:-translate-y-1 hover:shadow-[0_12px_24px_-8px_rgba(0,0,0,0.1)] cursor-default ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
