    ...
    <>
      <section ref={sectionRef} className="py-[100px] text-center" style={{ background: "linear-gradient(180deg, #ffffff 0%, #f0fdfa 100%)" }}>
        <div className="max-w-[640px] mx-auto px-6">
          <h2 className={`text-3xl md:text-4xl font-extrabold mb-6 transition-all duration-[600ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{ color: "#0f172a", letterSpacing: "-0.02em", transitionTimingFunction: "cubic-bezier(0.22, 1, 0.36, 1)" }}>
            {t('about.closing.title')}
          </h2>
          <p className={`text-lg mb-10 transition-all duration-[600ms] delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{ color: "#64748b", transitionTimingFunction: "cubic-bezier(0.22, 1, 0.36, 1)" }}>
            {t('about.closing.subtitle')}
          </p>
          <div className={`transition-all duration-[600ms] delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{ transitionTimingFunction: "cubic-bezier(0.22, 1, 0.36, 1)" }}>
